...
local Library do
    ...
    Library = {
        ...
        Folders = {
            Directory = "Z3US",
            Configs = "Z3US/OneTap/Configs",
            Assets = "Z3US/OneTap/Assets",
            Themes = "Z3US/OneTap/Themes"
        },
    ...
    local Themes = {
        ["Z3US"] = {
            ["Background"] = FromRGB(11, 11, 11),
            ["Inline"] = FromRGB(11, 11, 11),
            ["Text"] = FromRGB(255, 255, 255),
            ["Element"] =  FromRGB(0, 0, 0),
            ["Image"] =  FromRGB(19, 0, 255),
            ["Accent"] = FromRGB(19, 0, 255),
            ["Light Accent"] = FromRGB(19, 0, 255),
            ["Border"] = FromRGB(33, 33, 57)
        }
    }

    Library.Theme = TableClone(Themes["Z3US"])
