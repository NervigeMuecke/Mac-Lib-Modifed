...
local function TableToColor3(colorTable)
	return Color3.fromRGB(colorTable.R * 255, colorTable.G * 255, colorTable.B * 255)
end

function Functions:saveColorsToFile()
	writefile(settingsFileName, HttpService:JSONEncode({
		Animation = MacLib.Animation,
		Color1 = Color3ToTable(MacLib.Color1),
		Color2 = Color3ToTable(MacLib.Color2),
		Color3 = Color3ToTable(MacLib.Color3)
	}))
end

function Functions:loadColorsFromFile()
	local success, data = pcall(function()
		return HttpService:JSONDecode(readfile(settingsFileName))
	end)

	if success and data then
		MacLib.Color1 = data.Color1 and TableToColor3(data.Color1) or MacLib.Color1
		MacLib.Color2 = data.Color2 and TableToColor3(data.Color2) or MacLib.Color2
		MacLib.Color3 = data.Color3 and TableToColor3(data.Color3) or MacLib.Color3
		MacLib.Animation = data.Animation or MacLib.Animation
	end
end

function Functions:resetcolors()
	MacLib.Color1 = Color3.fromRGB(8, 0, 122)
	MacLib.Color2 = Color3.fromRGB(11, 11, 11)
	MacLib.Color3 = Color3.fromRGB(8, 0, 122)
	Functions:saveColorsToFile()
end

Functions:loadColorsFromFile()
...
function MacLib:Window(Settings)
	...
	--[[gradient.Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0, Color3.fromRGB(8, 0, 122)),
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(11, 11, 11)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(8, 0, 122)),
	})]]
